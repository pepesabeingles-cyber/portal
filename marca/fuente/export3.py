...
for px in (32, 180, 512):
    tile(SMALL if px <= 32 else SYM, 512, 0.12 if px <= 32 else 0.2, 0, fn_png=f"{OUT}/iconos/gc_icono_{px}.png", px=px)
tile(SYM, 1080, 0.22, 0, f"{OUT}/iconos/gc_avatar.svg", f"{OUT}/iconos/gc_avatar_1080.png", 1080)
